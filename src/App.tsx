  ...
  return (
    <div>
      ...
      <nav>
        <ul>
          <li >
            <Link to="/bestbirds">Все самые красивые фотографии птиц Казахстана </Link>
          </li>
          <li >
            <Link to="/bestbirdsn">Все самые интересные фотографии птиц Казахстана</Link>
          </li>
          <li >
            <Link to="/bestbirdsi">Все самые важные фотографии птиц Казахстана</Link>
          </li>
          <li>
...
function Home() {
  return (
    ...
    <div>
        ...
        <p><i>          
          Здесь выбраны только самые лучшие фотографии сообщества "Птицы Казахстана", т.е. снимки набравшие больше всего реакций "красиво", "интересно" и "важно" в сообществе за текущий и предыдущий месяцы.<br/>
          Все ссылки - включая саму фотографию, автора снимка, вид птицы - ведут на соответствуюшие страницы сайта сообщества "Птицы Казахстана".<br/>
          Сайт сообщества бёрдвотчеров "Птицы Казахстана" расположен по адресу: <a href="https://kz.birding.day" target="_blank" title="Новый адрес сообщества бёрдвотчеров 'Птицы Казахстана'">https://kz.birding.day</a>
        </i></p>
        
    </div>

    <div>
      <h3>Четыре самые красивые:</h3>
      <div>
        <Cards count={4} fileName={"dailybest.json"}/>
      </div>
      <h3>Четыре самые интересные:</h3>
      <div>
        <Cards count={4} fileName={"dailynoteunq.json"}/>
      </div>
      <h3>Четыре самые важные:</h3>
      <div>
...
function BestBirds() {
  return (
    <div>
      <h3>Все лучшие фотографии сообщества "Птицы Казахстана", отмеченные как красивые за месяц:</h3>
      <div>
...
function BestBirdsN() {
  return (
    <div>
      <h3>Все лучшие фотографии сообщества "Птицы Казахстана", отмеченные как интересные за месяц:</h3>
      <div>
...
function BestBirdsI() {
  return (
    <div>
      <h3>Все лучшие фотографии сообщества "Птицы Казахстана", отмеченные как важные за месяц:</h3>
      <div>
